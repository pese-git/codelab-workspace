...
**Команда разработки** (СНГ рынок):

| Роль | FTE | Зарплата (год) | Обязанности |
|------|-----|----------------|-------------|
| **Tech Lead** | 1.0 | $45,000 | Архитектура, code review, технические решения |
| **Backend Engineer** | 2.0 | $60,000 | Agent Runtime, Gateway, LLM Proxy |
| **Frontend Engineer** | 1.5 | $45,000 | Flutter IDE, UI/UX |
| **ML Engineer** | 1.0 | $40,000 | Промпт-инжиниринг, RAG, fine-tuning |
| **DevOps Engineer** | 0.5 | $15,000 | Инфраструктура, CI/CD, мониторинг |
| **QA Engineer** | 0.5 | $12,000 | Тестирование, автоматизация |
| **Product Manager** | 0.5 | $15,000 | Roadmap, приоритизация, feedback |

**Итого**: 7 FTE, **$232,000/год**

*Примечание: Зарплаты указаны для рынка СНГ (Беларусь, Россия, Казахстан) в долларовом эквиваленте. Средние ставки: Senior - $3,000-4,000/мес, Middle - $2,000-2,500/мес, Junior - $1,000-1,500/мес.*

### 9.2 Технологические ресурсы

**Облачная инфраструктура** (Selectel/Yandex Cloud/VK Cloud):

| Ресурс | Спецификация | Стоимость/месяц |
|--------|--------------|-----------------|
| **Compute** | 4x VPS (4 vCPU, 8GB RAM) | $80 |
| **Database** | PostgreSQL managed (2 vCPU, 4GB) | $40 |
| **Cache** | Redis managed (2GB) | $20 |
| **Storage** | 100GB SSD | $5 |
| **Load Balancer** | L7 балансировщик | $10 |
| **Monitoring** | Prometheus + Grafana (self-hosted) | $5 |

**Итого инфраструктура**: ~$160/месяц (для 100 пользователей)

*Примечание: Цены на облачные ресурсы в СНГ на 40-50% ниже AWS/GCP. Альтернативы: Selectel (РФ), Yandex Cloud (РФ), VK Cloud (РФ), Hetzner (EU, но доступен).*

**LLM API** (переменные затраты):

| Провайдер | Модель | Стоимость | Использование |
|-----------|--------|-----------|---------------|
| OpenAI | GPT-4 Turbo | $10/1M input tokens | 20% запросов |
| OpenAI | GPT-3.5 Turbo | $0.5/1M input tokens | 30% запросов |
| Anthropic | Claude 3 Opus | $15/1M input tokens | 10% запросов |
| Ollama | Local (приоритет) | $0 (только GPU) | 40% запросов |

**Средняя стоимость на пользователя**: $3-5/месяц (при активном использовании)

*Примечание: Акцент на локальные модели (Ollama) для снижения затрат на API.*

**GPU для Ollama** (рекомендуется):

**Вариант 1: Облако**
- NVIDIA RTX 4090 (24GB): $200-300/месяц (Selectel GPU Cloud)
- NVIDIA A100 (40GB): $600-800/месяц (Yandex Cloud)

**Вариант 2: Собственный сервер** (рекомендуется для СНГ)
- Сервер с NVIDIA RTX 4090: $4,000-5,000 единоразово
- Электричество: ~$30/месяц
- Окупаемость: 15-20 месяцев

### 9.3 Общий бюджет (годовой) - СНГ рынок

| Категория | Стоимость | Примечание |
|-----------|-----------|------------|
| **Зарплаты** (7 FTE) | $232,000 | Средние ставки СНГ |
| **Инфраструктура** ($160 × 12) | $1,920 | Selectel/Yandex Cloud |
| **LLM API** (1000 польз. × $4 × 12) | $48,000 | 40% через Ollama |
| **GPU сервер** (амортизация) | $1,500 | $5,000 / 3 года + электричество |
| **Инструменты и лицензии** | $8,000 | JetBrains, GitHub, etc. |
| **Маркетинг** | $20,000 | Локальные каналы |
| **Офис/коворкинг** | $12,000 | $1,000/мес (опционально) |
| **Прочее** (10% buffer) | $32,342 | Резерв |

**Итого**: ~$355,762/год

**Экономия по сравнению с US рынком**: ~$587,598/год (62% дешевле)

### 9.3.1 Сравнение бюджетов

| Статья | US рынок | СНГ рынок | Экономия |
|--------|----------|-----------|----------|
| Зарплаты | $700,000 | $232,000 | $468,000 (67%) |
| Инфраструктура | $3,600 | $1,920 | $1,680 (47%) |
| LLM API | $84,000 | $48,000 | $36,000 (43%) |
| GPU | $18,000 | $1,500 | $16,500 (92%) |
| Прочее | $137,760 | $72,342 | $65,418 (47%) |
| **ИТОГО** | **$943,360** | **$355,762** | **$587,598 (62%)** |
